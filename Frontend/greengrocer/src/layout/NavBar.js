  ...
  return (
   <div>
      ...
      <MDBNavbar expand='lg' dark bgColor='primary' className='fixed-top'>
        <MDBContainer fluid>
          <MDBNavbarBrand href='http://localhost:3000/'>Pizza Hut</MDBNavbarBrand>
          <MDBNavbarToggler
            type='button'
      ...
      <li key={categ.id}>
        ...
        >
          {categ.categoryName}
              ...
              {sessionStorage.getItem('user') && JSON.parse(sessionStorage.getItem('user')).userRole=="ADMIN"
                &&
                <li className="nav-item">
                  <a href="/adminhome" className="btn btn-success">ADMIN</a>
                </li>
                }
